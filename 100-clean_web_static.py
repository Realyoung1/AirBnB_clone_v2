#!/usr/bin/python3
# funcs scripted that deletes out-of-date archived
...
def deploy():
    """creates and distris the archive to your web servers"""
...
def do_clean(number=0):
    """deletes all the  out-of-date archives"""
    if number == '0':
        number = int(number) + 1
    else:
        number = int(number)
